...
TOP_LEVEL_NAME="STSource"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/jtech/snap/IntelFPGA_lite/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_source_bfm.sv" -work st_source_bfm_0          
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/STSource.v"                                                               
fi
