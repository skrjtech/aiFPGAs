...
vsim -L altera_mf_ver -c $env(LIBRARY_NAME)Work.new_src_txd_tb -t 10us

# Add Wave
add wave -divider TestBench
add wave -bin sim:/new_src_txd_tb/clock
add wave -bin sim:/new_src_txd_tb/reset

add wave -divider Transmit
add wave -hex sim:/new_src_txd_tb/uUartByteTxD/*

add wave -divider Recieve
add wave -hex sim:/new_src_txd_tb/uUartRxD/*
